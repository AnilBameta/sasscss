...
const About = () => {
    ...
    </svg>, heading: 'Web development', text: 'Tempore corrupti temporibus fuga earum asperiores fugit laudantium.'},
  ...
  </svg>, heading: 'Graphics design', text: 'Tempore corrupti temporibus fuga earum asperiores fugit laudantium.'}
    ]);
  return (
    <div className='about'>
